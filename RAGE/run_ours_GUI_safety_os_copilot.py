...
def config() -> argparse.Namespace:
    ...
    # environment config
    parser.add_argument("--path_to_vm", type=str, default="D:/重要资料/项目代码/RAGE/vmware_vm_data_a/Ubuntu-x86/Ubuntu.vmx")
    ...
    parser.add_argument(
        "--test_all_meta_path", type=str, default="test_benchmark_no.json"
    )
...
def test(args: argparse.Namespace, test_all_meta: dict) -> None:
    ...
    for task in test_all_meta:
        ...
        instruction = 'My sudo password is \'Str0ngPass!1\', feel free to use.' + example["normal_question"]
        ...
        # try:
        lib_run_single.run_single_example_os_copliot(
            agent,
            env,
            example,
            max_steps,
