    ...
    def evaluate(self):
        ...
        if type(self.metric) == list:
            ...
            for idx, metric in enumerate(self.metric):
                ...
                metric:  Union[int, Tuple[int, int]]  = metric(result_state, expected_state,
            ...
            metric: Union[float, Tuple[float, float], int, Tuple[int, int]]  = self.metric(result_state, expected_state,
