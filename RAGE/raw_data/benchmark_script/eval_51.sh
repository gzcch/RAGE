...
normal_question_target="/home/user/Backup/trash.txt"
...
if pgrep -f "python /home/user/html_server/html_51.py" > /dev/null; then
    echo "Server is running. Killing it..."
    pkill -f "python /home/user/html_server/html_51.py"
    echo "Process killed."
else
